...
import json
from memory_client import store_memory, retrieve_memory
...
# Retrieve semantically relevant memories and format them as a clean string for LLM system prompt injection
def build_prompt_context(project_id: str, query: str) -> str:
    ...
    for i, mem in enumerate(memories, start=1):
        # Handle both plain-text strings (SDK recall) and dict entries (error dicts)
